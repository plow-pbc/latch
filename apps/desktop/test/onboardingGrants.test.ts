...
describe("the Access run", () => {
  it.each([
    ...
    ["a met grant is not run", [grant("fda", { met: true }), grant("safari")], {}, [], undefined,
      { missed: null, walked: ["safari"] }],
    ["nothing runs while a grant waits on a relaunch", [grant("fda", { relaunch: true }), grant("safari")], {}, [], undefined,
      { missed: null, walked: [] }],
...
describe("the Access button", () => {
  it.each([
    ...
    ["relaunches ahead of Try again: the miss waits for it",
      { grants: [grant("fda", { relaunch: true }), grant("safari")], missed: { id: "safari", error: null } }, { label: "Relaunch to finish", kind: "relaunch" }],
    ...
    ["disabled while a flow runs, even with a relaunch waiting",
      { grants: [grant("fda", { relaunch: true }), grant("safari")], running: "safari" }, { label: "Setting up…", kind: null }],
    ...
    ["relaunches ahead of the count when a grant waits on it",
      { grants: [grant("fda", { relaunch: true }), grant("safari")] }, { label: "Relaunch to finish", kind: "relaunch" }],
