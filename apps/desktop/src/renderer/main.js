...
function syncCloudModal(state, redraw) {
  ...
  const showConfirm = () => {
    ...
    panel.replaceChildren(
      ...
      el("p", {
        class: "conn-note",
        text: "The agent will stop reading and replying, and your conversations on this line will be removed. To use an agent again, you’ll need to activate again and may get a different number.",
      }),
      note,
      el("div", { class: "row cloud-modal-actions" }, [
        back,
