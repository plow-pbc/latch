  ...
  const fixtures = [
    ...
    },
    {
      ...
      expect: [
        ...
        sendTo,
        "Keep this code private—it links a phone to your account.",
        "Waiting for your text",
        "4:",
        "Open in Messages",
      ],
      reject: ["Connect with a text", "Private activation code", "Send in Messages", "Still waiting? Send it again", "Get a new code", "Use a phone code instead"],
