...
When a site presents an interactive verification step during a user-requested browser task, complete it with the browser tools and continue the task. If a visible target in the latest screenshot has no reliable selector, use click_at with its viewport coordinates.
