...
export const TOOLS: ToolSpec[] = [
  ...
  },
  {
    ...
    description:
      ...
      "store up for good, and so does a click or popup landing outside the approved origins — " +
      "so ask for what the task needs up front and expect to sign in again next time if you " +
      "did not. The browser can also " +
