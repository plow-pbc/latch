...
export type { LoadedPlugin } from "./plugins/registry.js";
export { installPlugin, removePlugin, listInstalled, listInstalledNames, readInstalled, pluginDirs } from "./plugins/install.js";
export type { Installed } from "./plugins/install.js";
export { parseManifest, PluginError } from "./plugins/manifest.js";
export type { PluginManifest } from "./plugins/manifest.js";
export { classifyArgv, ruleArgv } from "./plugins/argvRules.js";
